                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                @forelse($rows as $key=>$row)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $pubType[$row->type_of_publication]}}</td>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div><label class='block'><span class='text-gray-700 @error('
                                                ...
                                                @enderror'>Type of publication</span><select
                                                    ...
                                                    @endforeach
                                                </select>@error('type_of_publication')<span
                                                        class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                        </div>
                                        <div><label class='block'><span class='text-gray-700 @error(' description')
                                                text-red-500 @enderror'>Description</span><input type='text'
                                                ...
                                                wire:model='description'>@error('description')<span
                                                        class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                        </div>
