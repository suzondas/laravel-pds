                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                @forelse($rows as $key=>$row)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->ground}}</td>
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div><label class='block'><span class='text-gray-700 @error(' title')
                                                text-red-500 @enderror'>Title</span><input type='text'
                                                ...
                                                focus:ring-opacity-50' wire:model='title'>@error('title')<span
                                                        class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                        </div>
                                        <div><label class='block'><span class='text-gray-700 @error(' ground')
                                                text-red-500 @enderror'>Ground</span><input type='text'
                                                                                            class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                                            ground') border-red-500
                                                @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                                focus:ring-opacity-50' wire:model='ground'>@error('ground')<span
                                                        class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                        </div>
                                        <div><label class='block'><span class='text-gray-700 @error(' date')
                                                text-red-500 @enderror'>Date</span><input type='date'
                                                                                          class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                                          date') border-red-500
                                                @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                                focus:ring-opacity-50' wire:model='date'>@error('date')<span
                                                        class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                        </div>
