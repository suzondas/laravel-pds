                        ...
                        @forelse($rows as $row)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    @foreach($wings as $key=>$val)
                                        @if($row->wing_id==$val->id)
                                            {{$val->name}}
                                        @endif
                                    @endforeach
                                </td>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    <div><label class='block'><span
                                                class='text-gray-700 @error('wing_id') text-red-500  @enderror'>Wing id</span>
                                        </label>
                                        <select
                                            class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('office_id')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
                                            wire:model='wing_id'>
                                    ...
                                    <div><label class='block'><span
                                                ...
                                                type='text'
                                                class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('name')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
                                                wire:model='name'>@error('name')<span
                                                class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span
                                                class='text-gray-700 @error('name_bangla') text-red-500  @enderror'>Name in Bangla</span><input
                                                type='text'
                                                class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('name_bangla')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
