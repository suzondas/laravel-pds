                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                @forelse($rows as $key=>$row)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->name_bangla}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->date_of_birth}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $children_sex_helper[$row->sex]}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $special_child_helper[$row->special_child]}}</td>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div><label class='block'><span class='text-gray-700 @error(' name')
                                            text-red-500
                                            @enderror'>Name</span><input type='text'
                                                                         class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                         name') border-red-500 @enderror
                                            focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                            focus:ring-opacity-50' wire:model='name'>@error('name')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' name_bangla')
                                            text-red-500 @enderror'>Name bangla</span><input type='text'
                                                                                             class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                                             name_bangla')
                                            border-red-500 @enderror focus:border-indigo-300 focus:ring
                                            focus:ring-indigo-200 focus:ring-opacity-50'
                                            wire:model='name_bangla'>@error('name_bangla')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' date_of_birth')
                                            text-red-500 @enderror'>Date of birth</span><input type='date'
                                                                                               class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                                               date_of_birth')
                                            border-red-500 @enderror focus:border-indigo-300 focus:ring
                                            focus:ring-indigo-200 focus:ring-opacity-50'
                                            wire:model='date_of_birth'>@error('date_of_birth')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error('sex') text-red-500
                                            @enderror'>Sex</span><select
                                                    class='mt-1 block w-full rounded-md border-gray-300 shadow-sm
                                            focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                            focus:ring-opacity-50' wire:model='sex'>
                                                <option>Select</option>
                                                @foreach($children_sex_helper as $key=>$val)
                                                    <option value="{{$key}}">{{$val}}</option>
                                                @endforeach
                                            </select>@error('sex')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' special_child')
                                            text-red-500 @enderror'>Special child</span><select
                                                    class='mt-1 block w-full rounded-md border-gray-300 shadow-sm
                                            focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                            focus:ring-opacity-50' wire:model='special_child'>
                                                <option>Select</option>
                                                @foreach($special_child_helper as $key=>$val)
                                                    <option value="{{$key}}">{{$val}}</option>
                                                @endforeach
                                            </select>@error('special_child')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
