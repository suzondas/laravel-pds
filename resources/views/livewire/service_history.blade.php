                                ...
                                @forelse($rows as $key=>$row)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            @foreach($designations as $key1=>$val1)
                                                @if($val1['id']==$row->designation_id)
                                                    {{$val1['name_english']}}
                                                @endif
                                            @endforeach
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            @foreach($offices as $key1=>$val1)
                                                @if($val1['id']==$row->office_id)
                                                    {{$val1['name']}}
                                                @endif
                                            @endforeach
                                        </td>
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div><label class='block'><span class='text-gray-700 @error(' designation_id')
                                                text-red-500 @enderror'>Designation</span>
                                                <select wire:model="designation_id" class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                                                focus:ring-indigo-200 focus:ring-opacity-50'>
                                                    <option>Select</option>
                                                    @foreach($designations as $key2=>$val2)
                                                        <option value="{{$val2['id']}}">{{$val2['name_english']}}</option>
                                                    @endforeach
                                                </select>
                                                @error('designation_id')<span
                                                        class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                        </div>
                                        <div><label class='block'><span class='text-gray-700 @error(' office_id')
                                                text-red-500 @enderror'>Office id</span>
                                                <select wire:model="office_id" class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                                                focus:ring-indigo-200 focus:ring-opacity-50'>
                                                    <option>Select</option>
                                                    @foreach($offices as $key2=>$val2)
                                        ...
                                        <div><label class='block'><span class='text-gray-700 @error(' to') text-red-500
                                                @enderror'>To</span><input type='date'
                                                                           class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
