                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                @forelse($rows as $key=>$row)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->course_title}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->institution}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->position}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->from}}</td>

                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row->to}}</td>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div><label class='block'><span class='text-gray-700 @error(' course_title')
                                            text-red-500 @enderror'>Course title</span><input type='text'
                                            ...
                                            wire:model='course_title'>@error('course_title')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' institution')
                                            text-red-500 @enderror'>Institution</span><input type='text'
                                                                                             class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                                             institution')
                                            border-red-500 @enderror focus:border-indigo-300 focus:ring
                                            focus:ring-indigo-200 focus:ring-opacity-50'
                                            wire:model='institution'>@error('institution')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' position')
                                            text-red-500 @enderror'>Position</span><input type='text'
                                                                                          class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('
                                                                                          position') border-red-500
                                            @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                            focus:ring-opacity-50' wire:model='position'>@error('position')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' from')
                                            text-red-500 @enderror'>From</span><input type='date'
                                                                                      ...
                                                                                      from') border-red-500
                                            @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200
                                            focus:ring-opacity-50' wire:model='from'>@error('from')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
                                    <div><label class='block'><span class='text-gray-700 @error(' to') text-red-500
                                            ...
                                            focus:ring-opacity-50' wire:model='to'>@error('to')<span
                                                    class='text-red-500 text-sm'>{{ $message }}</span>@enderror</label>
                                    </div>
